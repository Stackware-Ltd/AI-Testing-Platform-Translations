...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Datenschutzerklärung\n\n### 1. Verantwortlicher und Geltungsbereich\n\nDiese Datenschutzerklärung erläutert die Verarbeitung personenbezogener Daten beim Besuch und bei der Nutzung von RuleFox, einschließlich Unternehmenskonten, Einladungen von Beschäftigten, Tests, Nachweisen, Abrechnung, Support und einwilligungsbasierter Analyse.\n\nVerantwortlicher ist:\n\nFehr GmbH\nBlumenthal 6\n59457 Werl\nDeutschland\n\nTelefon: +49 (0) 2922 8814046\nE-Mail: info@fe.hr\n\n### 2. Verarbeitete Daten\n\nJe nach Nutzung von RuleFox verarbeiten wir:\n\n- Konto- und Kontaktdaten wie Name, E-Mail-Adresse, Rolle, Unternehmen und Sprache;\n- Daten zur Mandanten- und Beschäftigtenverwaltung, einschließlich Einladungen und zugewiesener Tests;\n- Testdaten wie Antworten, Punktzahl, Abschlussstatus, Zertifikate und Nachweise;\n- Vertrags- und Abrechnungsdaten wie erworbene Credits, Zahlungsstatus, Rechnungen und Transaktionsreferenzen;\n- Mitteilungen und Supportanfragen;\n- technische und sicherheitsbezogene Daten wie IP-Adresse, Browser, Geräteinformationen, Zeitstempel, aufgerufene URLs und Serverprotokolle;\n- Einwilligungseinstellungen und, nur soweit zulässig, Analyse- oder Marketingkennungen und Ereignisdaten.\n\nKartendaten werden in Zahlungskomponenten von Stripe eingegeben und von RuleFox nicht als vollständige Kartendaten gespeichert.\n\n### 3. Zwecke und Rechtsgrundlagen\n\nWir verarbeiten personenbezogene Daten, um RuleFox bereitzustellen und zu schützen, Konten und Tests zu verwalten, Verträge zu erfüllen, Zahlungen abzuwickeln, mit Nutzern zu kommunizieren, gesetzliche Pflichten zu erfüllen, Missbrauch zu verhindern, Fehler zu analysieren und den Dienst zu verbessern.\n\nRechtsgrundlage ist je nach Verarbeitung die Vertragserfüllung oder Durchführung vorvertraglicher Maßnahmen (Art. 6 Abs. 1 lit. b DSGVO), eine rechtliche Verpflichtung (Art. 6 Abs. 1 lit. c DSGVO), unser berechtigtes Interesse am Betrieb und Schutz des Dienstes (Art. 6 Abs. 1 lit. f DSGVO) oder eine Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Erforderliche Einwilligungen können Sie jederzeit mit Wirkung für die Zukunft über „Präferenzen verwalten“ widerrufen.\n\nMandanten sind dafür verantwortlich, dass ihre Verarbeitung von Beschäftigtendaten und der Versand von Testeinladungen auf einer gültigen Rechtsgrundlage beruhen. Je nach Fall kann der Mandant Verantwortlicher und die Fehr GmbH Auftragsverarbeiter auf Grundlage eines Auftragsverarbeitungsvertrags sein.\n\n### 4. Hosting und Dienstleister\n\nRuleFox setzt sorgfältig ausgewählte Dienstleister ein, soweit dies für den Betrieb erforderlich ist. Dazu können gehören:\n\n- netcup GmbH für das Infrastrukturhosting;\n- selbst betriebener Objektspeicher für Dateien und Nachweise;\n- Cloudflare für Inhaltsauslieferung, Verkehrssicherheit und Netzwerkschutz;\n- Stripe für Zahlungsabwicklung und Abrechnung;\n- Postmark für Transaktions-E-Mails;\n- Sentry für Fehleranalyse;\n- Meta Platforms für einwilligungsbasierte Messung über Pixel und Conversions API.\n\nDienstleister erhalten nur die für ihre Aufgabe erforderlichen Daten und sind an die anwendbaren vertraglichen und datenschutzrechtlichen Pflichten gebunden.\n\n### 5. Meta-Messung\n\nWenn Sie in Marketingmessung einwilligen, kann RuleFox Browserereignisse über Meta Pixel und Kaufereignisse über die Meta Conversions API übermitteln. Je nach Verfügbarkeit können Ereignistyp und -zeit, Seiten-URL, Bestellwert und Währung, Produktkennungen, Meta-Browser- oder Klickkennungen, IP-Adresse, User-Agent sowie gehashte Kennungen wie E-Mail-Adresse oder externe Nutzer-ID verarbeitet werden. Browser- und Server-Kaufereignisse verwenden dieselbe Ereignis-ID zur Deduplizierung.\n\nSie können diese Einwilligung verweigern oder später über „Präferenzen verwalten“ widerrufen. Wesentliche Konto-, Test- und Zahlungsfunktionen bleiben auch ohne Marketingeinwilligung verfügbar.\n\n### 6. Drittlandübermittlungen\n\nEinige Anbieter können Daten außerhalb des Europäischen Wirtschaftsraums verarbeiten. In diesem Fall stützen wir die Übermittlung auf einen anwendbaren Angemessenheitsbeschluss oder geeignete Garantien wie die Standardvertragsklauseln der Europäischen Kommission und, soweit erforderlich, zusätzliche Schutzmaßnahmen.\n\n### 7. Speicherdauer\n\nWir speichern Daten nur so lange, wie es für den jeweiligen Zweck erforderlich ist. Konto- und Testdaten werden grundsätzlich für die Dauer des Vertragsverhältnisses aufbewahrt und anschließend gelöscht oder anonymisiert, sofern der Mandant keine frühere Löschung verlangt oder gesetzliche Pflichten eine längere Speicherung erfordern. Abrechnungs- und Steuerunterlagen werden für die gesetzlichen Fristen gespeichert. Sicherheits- und Fehlerprotokolle werden nur für begrenzte Betriebszeiträume aufbewahrt. Einwilligungsnachweise werden so lange gespeichert, wie dies zum Nachweis und zur Beachtung Ihrer Auswahl erforderlich ist.\n\n### 8. Ihre Rechte\n\nUnter den Voraussetzungen der DSGVO haben Sie Rechte auf Auskunft, Berichtigung, Löschung, Einschränkung, Datenübertragbarkeit und Widerspruch gegen eine auf berechtigten Interessen beruhende Verarbeitung. Eine Einwilligung können Sie jederzeit widerrufen, ohne dass die Rechtmäßigkeit der vorherigen Verarbeitung berührt wird. Außerdem können Sie sich bei einer zuständigen Datenschutzaufsichtsbehörde beschweren.\n\nZur Ausübung Ihrer Rechte wenden Sie sich an info@fe.hr.\n\n### 9. Sicherheit und Änderungen\n\nWir setzen angemessene technische und organisatorische Maßnahmen ein, darunter verschlüsselte Übertragung und Zugriffskontrollen. Kein Internetdienst kann absolute Sicherheit garantieren. Wir aktualisieren diese Erklärung, wenn sich Dienste, Anbieter oder rechtliche Anforderungen ändern; die aktuelle Fassung wird in RuleFox veröffentlicht.'**
